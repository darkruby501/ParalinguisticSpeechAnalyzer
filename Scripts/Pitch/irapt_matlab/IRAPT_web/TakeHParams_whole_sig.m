function [Amps, Frc, Phs] = TakeHParams_whole_sig(Sig, Cfg)
%TakeHParams_whole_sig -- calculates harmonic parameters of signal Sig.
% Cfg  -- configuration file

M = 360;                % Number of filter bank channels
K = 4;                  % Number of merging subchannel
S = Cfg.step_sub_smp;   % Decimation coefficient
N=317;                  % Filter prototype order
