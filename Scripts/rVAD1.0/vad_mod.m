function [vad_seg]=vad_mod(data,fs,fpitch)
...
if nargin < 2; error('Usage: vad(data,fs)'); end
vadThres = 0.1; foutwav = 0;
...
% if foutwav ~= 0;  wavwrite(dfdatarm,fs,16, foutwav); end
